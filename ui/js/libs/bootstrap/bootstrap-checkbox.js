...
!function($) {
    ...
    Checkbox.prototype = {
        ...
        init: function (e) {
            ...
            this.$newElement =  this.button =this.$element.next('.bs-chk');
          //  this.button = this.$newElement.find('.bs-chk');
            ...
            var template =
                '<span class="bs-chk">' +
                 //   '<button type="button" class="btn clearfix'+additionalButtonStyle+'">' +
                    ...
                    '<span class="bs-checkbox fa '+this.options.checkedClass+'" style="display:none;"></span>' +
                    '<span class="bs-checkbox fa '+this.options.uncheckedClass+'"></span>' +
                    '<span class="bs-checkbox fa '+this.options.indeterminateClass+'" style="display:none;"></span>' +
