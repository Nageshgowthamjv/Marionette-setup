...
(function ($) {
    ...
    var CAPTION_TEMPLATE = '<div class="form-control file-caption {class} {mandatoryClass}">\n' +
    ...
    var FileInput = function (element, options) {
        ...
        this.mandatoryClass = options.mandatoryClass;
    ...
    FileInput.prototype = {
        ...
        renderMain: function () {
            ...
            var caption = self.captionTemplate.replace('{class}', css).replace('{mandatoryClass}', self.mandatoryClass);
            return self.mainTemplate.replace('{class}', self.mainClass).
                replace('{preview}', self.showPreview ? preview : '').
    ...
    $.fn.fileinput.defaults = {
		...
		disableDefaultChangeEvent: false
    };
