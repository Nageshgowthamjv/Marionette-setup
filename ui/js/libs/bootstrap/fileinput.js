...
//FileInput plugin definition
    $.fn.fileinputFunc = function (option) {
        ...
        this.each(function () {
            ...
            if (!data) {
                defaults = $.extend({}, $.fn.fileinputFunc.defaults);
    ...
    $.extend($.fn.fileinputFunc.defaults, $.fn.fileinputLocales.en);

    $.fn.fileinputFunc.Constructor = FileInput;
